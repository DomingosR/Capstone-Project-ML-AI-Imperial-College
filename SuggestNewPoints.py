...
# using Upper Confidence Bounds as the objective function.
#
# The current version trades off exploration and exploitation in
# roughly equal importance.  I intend to adjust this in future
# versions to make the relevant parameters dependent on the
